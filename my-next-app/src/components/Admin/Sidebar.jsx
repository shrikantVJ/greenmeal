...
import { LayoutDashboard, Users, Megaphone, Package, Bell, UserCircle, Settings, LogOut, X } from 'lucide-react'
import { useRouter } from 'next/navigation'

const menuItems = [
  { name: 'Overview', icon: LayoutDashboard, component: 'Overview' },
  { name: 'Donors', icon: Users, component: 'Donors' },
  { name: 'Campaigns', icon: Megaphone, component: 'Campaigns' },
  { name: 'Inventory', icon: Package, component: 'Inventory' },
  { name: 'Donor Alerts', icon: Bell, component: 'DonorAlerts' },
...
export default function NGOSidebar({ onSelectComponent, closeSidebar }) {
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          >
            <Avatar className="h-10 w-10 mr-3">
              <AvatarImage src="/ngo-logo.png" alt="GreenMeal NGO" />
              <AvatarFallback>GM</AvatarFallback>
            </Avatar>
            <div>
              <h2 className="text-lg font-semibold text-green-800">GreenMeal NGO</h2>
              <p className="text-sm text-green-600">Food Waste Reduction</p>
            </div>
          </motion.div>
